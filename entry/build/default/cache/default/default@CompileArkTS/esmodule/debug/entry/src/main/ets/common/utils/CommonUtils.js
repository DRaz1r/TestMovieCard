...
export class CommonUtils {
    ...
    loginCheckArkTS(account, password) {
        let check = '';
        if (account === '') {
            return { "id": 16777286, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" };
        }
        else if (password === '') {
            return { "id": 16777287, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" };
        }
        else {

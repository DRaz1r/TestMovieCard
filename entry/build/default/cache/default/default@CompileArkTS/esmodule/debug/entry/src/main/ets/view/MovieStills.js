...
export default class MovieStills extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.margin({ right: { "id": 16777486, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.height({ "id": 16777485, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                List.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
                ...
                const item = _item;
                {
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Image.height({ "id": 16777482, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                            Image.borderRadius({ "id": 16777483, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                            if (!isInitialRender) {
                                Image.pop();
                            }
                            ViewStackProcessor.StopGetAccessRecording();

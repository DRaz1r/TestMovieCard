export class Collect extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.backgroundColor({ "id": 16777336, "type": 10001, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            Column.width('28vp');
            Column.height('28vp');
            Column.onClick(() => {
                //待添加数据库
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isComplete) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.labelIcon.bind(this)({ "id": 16777539, "type": 20000, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                });
            }
            else {
                this.ifElseBranchUpdateFunction(1, () => {
                    this.labelIcon.bind(this)({ "id": 16777517, "type": 20000, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                });
            }
            if (!isInitialRender) {
                If.pop();

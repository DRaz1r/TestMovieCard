...
export class MovieListPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 文本-热门电影预览
            Text.fontSize({ "id": 16777391, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            // 文本-热门电影预览
            ...
            // 文本-热门电影预览
            Text.height({ "id": 16777390, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                // 文本-热门电影预览
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 滚动-电影海报
            Swiper.height({ "id": 16777383, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                // 滚动-电影海报
                Swiper.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create(img);
                    Image.borderRadius({ "id": 16777375, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                    if (!isInitialRender) {
                        Image.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();

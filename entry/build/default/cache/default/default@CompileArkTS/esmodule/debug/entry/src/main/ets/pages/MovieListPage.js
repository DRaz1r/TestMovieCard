...
export class MovieListPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.backgroundColor({ "id": 16777317, "type": 10001, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 文本-热门电影预览
            Text.fontSize({ "id": 16777397, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            // 文本-热门电影预览
            ...
            // 文本-热门电影预览
            Text.height({ "id": 16777396, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                // 文本-热门电影预览
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 滚动-电影海报
            Swiper.height({ "id": 16777389, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            if (!isInitialRender) {
                // 滚动-电影海报
                Swiper.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create(img);
                    Image.borderRadius({ "id": 16777379, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
                    if (!isInitialRender) {
                        Image.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            // 文本-热门电影排行
            Text.create({ "id": 16777258, "type": 10003, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
            // 文本-热门电影排行
            Text.fontWeight(FontWeight.Bolder);
            // 文本-热门电影排行
            Text.fontSize({ "id": 16777397, "type": 10002, params: [], "bundleName": "com.huawei.moviecard", "moduleName": "entry" });
